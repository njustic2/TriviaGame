...
// if time, add in music or sound effects and images.
  ...
  var questionArray = [ 	//An array of objects. Each object has properties (question and answers) and values(the string containing the words in this case)
    ...
    questB = {
    var questionArray = [ 	//An array of objects. Each object has properties (questi
...
var count 	// The variable for the timer numbers
var counter	// A variable for the countdown function that sets the interval length.
